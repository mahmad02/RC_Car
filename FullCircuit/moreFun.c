...
void adc_line2(int ok) {
  display_line[3][NOTHING] = adc_char[NOTHING];
    display_line[3][ONE] = adc_char[ONE];
    display_line[3][TWO] = adc_char[TWO];
    display_line[3][THREE] = '.';
    display_line[3][FOUR] = adc_char[THREE];
    display_line[3][FIVE] = 's';
